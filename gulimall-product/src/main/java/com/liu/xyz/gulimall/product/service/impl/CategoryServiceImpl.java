...
public class CategoryServiceImpl extends ServiceImpl<CategoryDao, CategoryEntity> implements CategoryService {
    ...
    @Override
    public Long[] getThreePath(Long catelogId) {

        CategoryEntity categoryEntity = this.getById(catelogId);
        //Long parentCid = categoryEntity.getParentCid();
        ArrayList<Long> list = new ArrayList<>();

        getThreePath(categoryEntity.getParentCid(),list);
        list.add(catelogId);
        //Collections.reverse(list); 集合反转
        return list.toArray(new Long[list.size()]);
    }
    private List<Long> getThreePath(Long catelogId,List<Long> longs){
        ...
        longs.add(catelogId);
            ...
            CategoryEntity categoryEntity = this.getById(catelogId);
            getThreePath(categoryEntity.getParentCid(),longs);
            return longs;
